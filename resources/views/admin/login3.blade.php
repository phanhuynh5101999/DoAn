...
<body>
    ...
    <div class="box-form">
        ...
        <form action="{{route('user.postDangNhap')}}" method="POST">
            ...
            <a id='register' href="http://localhost/Phan_Thuc_Huynh_1711060722/public/register">SIGN UP</a>
            <a style="display: block;" id='register' href="http://localhost/Phan_Thuc_Huynh_1711060722/public/forget-password">FORGOT PASSWORD ?</a>
